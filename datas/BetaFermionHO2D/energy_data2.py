...
ax.errorbar(Z, E, yerr=E_error/np.sqrt(8000),
        linestyle="None", capsize=7, marker="o")
...
ax1 = fig.add_axes((left1, bottom1, width1, height1), aspect="equal")
...
ax2 = fig.add_axes((left2, bottom2, width2, height2), aspect="equal")
